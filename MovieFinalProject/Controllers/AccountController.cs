...
namespace Restaurant.Controllers
{
    public class AccountController : Controller
    {
        ...
        private readonly Mailing.IMailService _mailService;

        public AccountController(UserManager<AppUser> userManager, SignInManager<AppUser> signInManager, Mailing.IMailService mailService)
        {
        ...
        public async Task<IActionResult> GoogleResponse(string returnUrl = "/")
        {
            ...
            // Əvvəllər Google ilə login olubsa, birbaşa daxil et
            ...
            // Əgər yeni userdirsə → DB-də yarat
            ...
            if (result.Succeeded)
            {
                await _userManager.AddLoginAsync(user, info); // Google ilə əlaqələndir
