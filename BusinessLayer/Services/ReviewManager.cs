...
{
   public class ReviewManager : CrudManager<ReviewDto, ReviewCreateDto, ReviewUpdateDto, Review>, IReviewService
    {
        public ReviewManager(IRepositoryasync<Review> repository, IMapper mapper) : base(repository, mapper)
        {
