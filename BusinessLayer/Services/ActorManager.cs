...
{
    public class ActorManager : CrudManager<ActorDto, ActorCreateDto, ActorUpdateDto, Actor>,IActorService
    {
        public ActorManager(IRepositoryasync<Actor> repository, IMapper mapper) : base(repository, mapper)
        {
        }
    }
}
